...
float numLineSensorX = 0.15; //x value that the sensors are at on autonomous number line
float numLineWheelX = 0.65; //x value that the wheels are at on autonomous number line
...
public:
	RobotDemo(void)
	{
		...
		pid1 = new PIDController(0.05,0.0,0.005,pot,armMotor1, 0.01); //change to match with the pot
